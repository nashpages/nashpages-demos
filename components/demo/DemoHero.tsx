...
export function DemoHero({ config }: { config: DemoConfig }) {
  return (
    ...
    >
      <div className="mx-auto max-w-[1280px] px-6 pb-16 pt-12 md:px-12 md:pb-24 md:pt-16">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-12 md:items-end md:gap-16">
          ...
          <div className="md:col-span-7">
            ...
            <Reveal delay={0.08}>
              <h1
                className="mt-8 font-[family-name:var(--font-display)] tracking-[-0.01em] leading-[1.02] md:mt-12"
                style={{ color: "var(--demo-fg)" }}
              >
                <span className="block text-[44px] font-medium md:text-[72px] lg:text-[88px]">
                  {config.hero.headline}
                </span>
                {config.hero.sublineMuted ? (
                  <span
                    className="mt-1 block text-[44px] font-medium italic md:text-[72px] lg:text-[88px]"
            ...
            <Reveal delay={0.16}>
              <p
                className="mt-10 max-w-2xl text-base leading-[1.55] md:mt-12 md:text-lg"
                style={{ color: "var(--demo-muted)" }}
              >
