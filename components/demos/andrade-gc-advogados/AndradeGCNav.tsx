...
export function AndradeGCNav() {
  const { nav } = ANDRADEGC_DATA;
  ...
  // Cor: branca enquanto !pastHero (sobre o hero dark), navy quando passa
  ...
  return (
    <motion.header
      ...
      style={{
        backgroundColor: scrolled ? "rgba(247, 246, 244, 0.92)" : "transparent",
