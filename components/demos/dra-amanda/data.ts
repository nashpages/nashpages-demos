// Dra. Amanda Fistarol — Rouge Editorial v4 (cream warm + carmim fashion).
// Layout V3: SCROLL VERTICAL LONG-FORM COM PIN SECTIONS (NYT Snow Fall vibe).
...
export const AMANDA_DATA = {
  ...
  hero: {
    eyebrow: "/  DERMATOLOGIA  ·  CLÍNICA · CIRÚRGICA · ESTÉTICA · ONCOLÓGICA",
  ...
  sobre: {
    ...
    quote: "“Cada caso tem sua própria leitura.”",
