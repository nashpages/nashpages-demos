...
export function Atendimento() {
  ...
  return (
    <section id="atendimento" className="w-full lg:px-[120px] px-6 lg:py-[120px] py-16"
      ...
      <div className="mx-auto w-full max-w-[1440px]">
        ...
        <FadeUp delay={0.6}>
          <div className="mt-12 pt-6 border-t" style={{ borderColor: "var(--c-linha)" }}>
