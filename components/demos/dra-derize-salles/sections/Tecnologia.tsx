    ...
    <section id="tecnologia" className="w-full" style={{ backgroundColor: "var(--c-pedra)" }}>
      <div className="mx-auto w-full max-w-[1440px] px-6 lg:px-[80px] pt-20 lg:pt-[120px] pb-20 lg:pb-[120px]">
        ...
        <FadeUp delay={0.1} y={32} duration={0.9}>
          <h2 style={{ fontFamily: "var(--font-spectral)", fontStyle: "italic", fontWeight: 400, fontSize: "clamp(44px, 5.5vw, 76px)", lineHeight: "1.15", letterSpacing: "-1.4px", color: "var(--c-tinta)", margin: 0 }}>
          ...
          {tecnologia.list.map((t, i) => (
            <StaggerItem key={t.name}>
              <div className="grid grid-cols-[40px_1fr] gap-x-2 items-baseline">
                ...
                <div>
                  <h3 style={{ fontFamily: "var(--font-spectral)", fontWeight: 400, fontSize: "clamp(20px, 1.7vw, 24px)", lineHeight: "32px", letterSpacing: "-0.3px", color: "var(--c-tinta)", margin: 0 }}>
                    {t.name}
                  </h3>
                  <div className="h-1" />
        ...
        <FadeUp delay={0.5}>
          <p className="text-center" style={{ fontFamily: "var(--font-spectral)", fontStyle: "italic", fontWeight: 400, fontSize: "clamp(15px, 1.3vw, 18px)", lineHeight: "1.5", color: "var(--c-neblina)", margin: 0 }}>
