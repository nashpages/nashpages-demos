      ...
      <div className="mx-auto w-full max-w-[1440px]">
        ...
        <div className="hidden lg:grid pt-[120px] pb-[120px] px-[80px] grid-cols-[540px_1fr] gap-x-[80px]">
          ...
          <div className="flex flex-col pt-2">
            ...
            <FadeUp delay={0.1} y={32} duration={0.9}>
              <h2 style={{ fontFamily: "var(--font-cormorant-garamond)", fontStyle: "italic", fontWeight: 400, fontSize: "64px", lineHeight: "74px", letterSpacing: "-1.5px", color: "var(--c-tinta)", margin: 0 }}>
            ...
            <Stagger className="grid grid-cols-3 gap-x-6" staggerChildren={0.1}>
              {sobre.credenciais.map((c) => (
                <StaggerItem key={c.label}>
                  ...
                  <p className="mt-1" style={{ fontFamily: "var(--font-cormorant-garamond)", fontWeight: 400, fontSize: "22px", letterSpacing: "-0.3px", lineHeight: "30px", color: "var(--c-tinta)" }}>
                    {c.val}
                  </p>
                </StaggerItem>
              ))}
        ...
        <div className="lg:hidden">
          ...
          >
            ...
            >
              <Image src={sobre.photo} alt="Dra. Elisangela Medeiros" fill loading="eager" quality={100} sizes="100vw" className="object-cover object-center" />
            </motion.div>
          </motion.div>
          <div className="px-6 pt-12 pb-16">
            ...
            <FadeUp delay={0.1}>
              <h2 style={{ fontFamily: "var(--font-cormorant-garamond)", fontStyle: "italic", fontWeight: 400, fontSize: "36px", lineHeight: "44px", letterSpacing: "-0.8px", color: "var(--c-tinta)", margin: 0 }}>
                {sobre.headlineLines.map((line, i) => (
                  <span key={i} className="block">{line}</span>
                ))}
              </h2>
            ...
            <div className="grid grid-cols-3 gap-x-3">
              {sobre.credenciais.map((c) => (
                <div key={c.label}>
                  ...
                  <p className="mt-1" style={{ fontFamily: "var(--font-cormorant-garamond)", fontWeight: 400, fontSize: "16px", letterSpacing: "-0.2px", lineHeight: "22px", color: "var(--c-tinta)" }}>
                    {c.val}
                  </p>
                </div>
              ))}
